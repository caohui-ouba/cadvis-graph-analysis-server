    ...
    def from_gml_file(cls, path):
        ...
        for line in lines:
            ...
            if words[0] == 'id':
                ...
                in_edge = 1
                current_edge = (
                    int(words[1]), current_edge[1], current_edge[2])
            elif words[0] == 'target' and in_edge:
                current_edge = (current_edge[0], int(
                    words[1]), current_edge[2])
            elif words[0] == 'value' and in_edge:
                current_edge = (current_edge[0],
                                current_edge[1], int(words[1]))
        ...
        while 1:
            ...
            for node in network[0]:
                ...
                for e in self.edges_of_node[node]:
                    if e[0][0] == e[0][1]:
                        continue
                    if e[0][0] == node and self.communities[e[0][1]] == node_community or e[0][1] == node \
                            and self.communities[e[0][0]] == node_community:
